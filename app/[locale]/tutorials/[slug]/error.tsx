...
export default function TutorialDetailError({
  reset,
}: {
  ...
  const copy =
    locale === "en"
      ? {
          ...
          description: "Tutorial detail data is temporarily unavailable. Please try again later.",
          retry: "Retry",
        }
      : {
          eyebrow: "教程详情",
          title: "页面加载失败",
          description: "教程详情数据暂时不可用，可以稍后重试。",
          retry: "重新加载",
        };
