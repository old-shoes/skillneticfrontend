...
const skillList: SkillListItem[] = [
  {
    ...
    tags: [tag("t1", "GPT-4o", "gpt-4o", "model"), tag("t2", "小红书", "xiaohongshu", "scene"), tag("t3", "新手", "beginner", "difficulty"), tag("t4", "提示词", "prompt", "type")],
    difficulty: "beginner",
    type: "prompt",
  ...
  },
  {
    ...
    tags: [tag("t5", "DeepSeek", "deepseek", "model"), tag("t6", "新手", "beginner", "difficulty"), tag("t7", "工具配置", "tool_config", "type")],
    difficulty: "beginner",
    type: "tool_config",
  ...
  },
  {
    ...
    tags: [tag("t8", "GPT-4o", "gpt-4o", "model"), tag("t9", "Excel", "excel", "scene"), tag("t10", "进阶", "intermediate", "difficulty"), tag("t11", "工作流", "workflow", "type")],
  ...
  },
  {
    ...
    coverIcon: "prompt",
    category: categories[0],
    tags: [tag("t12", "Claude", "claude", "model"), tag("t13", "新手", "beginner", "difficulty"), tag("t14", "提示词", "prompt", "type")],
    difficulty: "beginner",
    type: "prompt",
  ...
  },
  {
    ...
    tags: [tag("t15", "Midjourney", "midjourney", "model"), tag("t16", "新手", "beginner", "difficulty"), tag("t17", "提示词", "prompt", "type")],
    difficulty: "beginner",
    type: "prompt",
  ...
  },
  {
    ...
    coverIcon: "user",
    category: categories[2],
    tags: [tag("t18", "GPT-4o", "gpt-4o", "model"), tag("t19", "简历", "resume", "scene"), tag("t20", "进阶", "intermediate", "difficulty"), tag("t21", "提示词", "prompt", "type")],
    difficulty: "intermediate",
    type: "prompt",
  ...
  },
  {
    ...
    coverIcon: "tutorial",
    category: categories[2],
    tags: [tag("t22", "ChatGPT", "chatgpt", "model"), tag("t23", "PPT", "ppt", "scene"), tag("t24", "新手", "beginner", "difficulty"), tag("t25", "工作流", "workflow", "type")],
    difficulty: "beginner",
    type: "workflow",
  ...
  },
  {
    ...
    tags: [tag("t26", "GPT-4o", "gpt-4o", "model"), tag("t27", "短视频", "short-video", "scene"), tag("t28", "进阶", "intermediate", "difficulty"), tag("t29", "提示词", "prompt", "type")],
    difficulty: "intermediate",
    type: "prompt",
  ...
  },
  {
    ...
    tags: [tag("t30", "ChatGPT", "chatgpt", "model"), tag("t31", "专业", "advanced", "difficulty"), tag("t32", "工作流", "workflow", "type")],
    difficulty: "advanced",
    type: "workflow",
  ...
  },
  {
    ...
    coverIcon: "workflow",
    category: categories[2],
    tags: [tag("t33", "Kimi", "kimi", "model"), tag("t34", "会议", "meeting", "scene"), tag("t35", "新手", "beginner", "difficulty"), tag("t36", "工作流", "workflow", "type")],
    difficulty: "beginner",
    type: "workflow",
  ...
  },
  {
    ...
    coverIcon: "workflow",
    category: categories[2],
    tags: [tag("t37", "DeepSeek", "deepseek", "model"), tag("t38", "进阶", "intermediate", "difficulty"), tag("t39", "工作流", "workflow", "type")],
    difficulty: "intermediate",
    type: "workflow",
    recommendedModels: ["DeepSeek", "ChatGPT"],
    favoriteCount: 2900,
  ...
  },
  {
    ...
    coverIcon: "prompt",
    category: categories[2],
    tags: [tag("t40", "Claude", "claude", "model"), tag("t41", "新手", "beginner", "difficulty"), tag("t42", "提示词", "prompt", "type")],
    difficulty: "beginner",
    type: "prompt",
    recommendedModels: ["Claude"],
    favoriteCount: 2500,
  ...
  },
  {
    ...
    tags: [tag("t43", "Gemini", "gemini", "model"), tag("t44", "论文", "paper", "scene"), tag("t45", "新手", "beginner", "difficulty"), tag("t46", "教程", "tutorial", "type")],
    difficulty: "beginner",
    type: "tutorial",
  ...
  },
  {
    ...
    tags: [tag("t47", "通义千问", "qwen", "model"), tag("t48", "社媒", "social-media", "scene"), tag("t49", "进阶", "intermediate", "difficulty"), tag("t50", "工作流", "workflow", "type")],
    difficulty: "intermediate",
    type: "workflow",
  ...
  },
  {
    ...
    category: categories[1],
    tags: [tag("t51", "DeepSeek", "deepseek", "model"), tag("t52", "新手", "beginner", "difficulty"), tag("t53", "工具配置", "tool_config", "type")],
    difficulty: "beginner",
    type: "tool_config",
  ...
  },
  {
    ...
    coverIcon: "prompt",
    category: categories[4],
    tags: [tag("t54", "ChatGPT", "chatgpt", "model"), tag("t55", "SEO", "seo", "scene"), tag("t56", "新手", "beginner", "difficulty"), tag("t57", "提示词", "prompt", "type")],
    difficulty: "beginner",
    type: "prompt",
  ...
  },
  {
    ...
    coverIcon: "prompt",
    category: categories[4],
    tags: [tag("t58", "Claude", "claude", "model"), tag("t59", "电商", "ecommerce", "scene"), tag("t60", "进阶", "intermediate", "difficulty"), tag("t61", "提示词", "prompt", "type")],
    difficulty: "intermediate",
    type: "prompt",
  ...
  },
  {
    ...
    coverIcon: "tutorial",
    category: categories[5],
    tags: [tag("t62", "Kimi", "kimi", "model"), tag("t63", "新手", "beginner", "difficulty"), tag("t64", "教程", "tutorial", "type")],
    difficulty: "beginner",
    type: "tutorial",
  ...
  },
  {
    ...
    coverIcon: "agent",
    category: categories[5],
    tags: [tag("t65", "ChatGPT", "chatgpt", "model"), tag("t66", "简历", "resume", "scene"), tag("t67", "进阶", "intermediate", "difficulty"), tag("t68", "Agent", "agent", "type")],
    difficulty: "intermediate",
    type: "agent",
  ...
  },
  {
    ...
    coverIcon: "workflow",
    category: categories[2],
    tags: [tag("t69", "通义千问", "qwen", "model"), tag("t70", "专业", "advanced", "difficulty"), tag("t71", "工作流", "workflow", "type")],
    difficulty: "advanced",
    type: "workflow",
    recommendedModels: ["通义千问", "GPT-4o"],
    favoriteCount: 2200,
...
export function getSkillsMockData(query: SkillListQuery): SkillListResponse {
  ...
  if (query.model) {
    list = list.filter((skill) => skill.tags.some((tagItem) => tagItem.type === "model" && tagItem.slug === query.model));
  }
  if (query.type) {
