  ...
  zh: {
    ...
    skills: {
      ...
      hero: {
        ...
        titleSuffix: "技能库",
        description: "按分类、场景、模型和类型筛选高质量 Skill，找到适合你的提示词、工作流和实用方法。",
  ...
  en: {
    ...
    skills: {
      ...
      hero: {
        ...
        titleHighlight: "Skillnetic",
        titleSuffix: "Library",
        description: "Filter high-quality Skills by category, scenario, model, and type to find the prompts, workflows, and methods that fit you.",
